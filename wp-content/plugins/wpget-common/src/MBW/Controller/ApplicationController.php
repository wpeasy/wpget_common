...
class ApplicationController {
    ...
    static function register_scripts(){
        ...
        wp_register_script('wpg-select2', '//cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js', ['jquery']);
        wp_register_style('wpg-select2', '//cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css');
    }
